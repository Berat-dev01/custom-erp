...
@section('title', __('Yeni Tedarikçi'))
@section('page-title', __('Yeni Tedarikçi'))
...
@section('content')
    <x-admin-panel::card>
        <form method="POST" action="{{ route('erp.suppliers.store') }}">
            @csrf
            <div class="row g-3">
                <div class="col-md-8"><x-admin-panel::input name="name" :label="__('Firma Adı')" :value="old('name')" required /></div>
                <div class="col-md-4"><x-admin-panel::input name="code" :label="__('Kod')" :value="old('code')" /></div>
                ...
                <div class="col-md-6"><x-admin-panel::input name="tax_number" :label="__('Vergi No')" :value="old('tax_number')" /></div>
                ...
                <div class="col-md-4"><x-admin-panel::input name="credit_limit" type="number" step="0.01" :label="__('Kredi Limiti')" :value="old('credit_limit', '0')" /></div>
                <div class="col-md-4"><x-admin-panel::input name="payment_terms_days" type="number" :label="__('Ödeme Vadesi (gün)')" :value="old('payment_terms_days', '30')" /></div>
            </div>
